...
// Funktion: sanitizeCart bündelt einen Teil der Seitenlogik.
...
// Funktion: encodeCart bündelt einen Teil der Seitenlogik.
...
// Funktion: decodeCart bündelt einen Teil der Seitenlogik.
...
// Funktion: getCartFromUrl bündelt einen Teil der Seitenlogik.
function getCartFromUrl() {
  const params = new URLSearchParams(window.location.search);
  return decodeCart(params.get('cart'));
}

// Funktion: storageAvailable bündelt einen Teil der Seitenlogik.
...
// Funktion: getCartFromStorage bündelt einen Teil der Seitenlogik.
...
// Funktion: saveCartToStorage bündelt einen Teil der Seitenlogik.
...
// Funktion: getCart bündelt einen Teil der Seitenlogik.
function getCart() {
...
// Funktion: getCartItems bündelt einen Teil der Seitenlogik.
...
// Funktion: calculateTotals bündelt einen Teil der Seitenlogik.
...
// Funktion: updateCartCount bündelt einen Teil der Seitenlogik.
...
// Funktion: updateStateLinks bündelt einen Teil der Seitenlogik.
...
// Funktion: escapeHTML bündelt einen Teil der Seitenlogik.
...
// Funktion: showToast bündelt einen Teil der Seitenlogik.
...
// Funktion: updateCartTotals bündelt einen Teil der Seitenlogik.
...
// Funktion: handleCartActions bündelt einen Teil der Seitenlogik.
...
// Funktion: renderCheckout bündelt einen Teil der Seitenlogik.
  ...
  form.addEventListener('submit', (event) => {
    ...
    if (storageAvailable()) {
      try {
        ...
        /* Nicht kritisch: Bestätigung nutzt zusätzlich die URL. */
      }
    }

    memoryCart = {};
    window.location.href = `bestellung.html?order=${encodedOrder}`;
  });
}

// Funktion: getOrderFromUrl bündelt einen Teil der Seitenlogik.
...
// Funktion: getOrderFromStorage bündelt einen Teil der Seitenlogik.
...
// Funktion: renderOrderConfirmation bündelt einen Teil der Seitenlogik.
function renderOrderConfirmation() {
  const container = document.getElementById('orderConfirmation');
  if (!container) return;

  const order = getOrderFromUrl() || getOrderFromStorage();
...
// Funktion: initSearch bündelt einen Teil der Seitenlogik.
function initSearch() {
