...
const slides = [
  {
    ...
    description: "Der 930 begründete die Turbo-Ära des 911. Turboaufladung, breite Kotflügel und der markante Heckspoiler machten ihn leistungsstark, kompromisslos und unverwechselbar."
  },
  {
    code: "964",
    model: "Porsche 911 964",
    period: "ca. 1988 bis 1994",
    image: "geschichte/assets/images/911-964.webp",
    alt: "Porsche 911 Generation 964",
    description: "Der 964 führte den 911 technisch in die Moderne. ABS, Servolenkung und erstmals permanenter Allradantrieb verbesserten Sicherheit und Alltagstauglichkeit, ohne die klassische Silhouette aufzugeben."
  },
  {
    code: "993",
    model: "Porsche 911 993",
    period: "ca. 1993 bis 1998",
    image: "geschichte/assets/images/911-993.webp",
    alt: "Porsche 911 Generation 993",
    description: "Der 993 war die letzte luftgekühlte 911-Generation. Sein weiterentwickeltes Fahrwerk verband hohe Stabilität mit zeitloser Form und machte ihn zu einem besonders begehrten Klassiker."
  },
  {
    code: "996",
    model: "Porsche 911 996",
    period: "ca. 1997 bis 2005",
    image: "geschichte/assets/images/911-996.webp",
    alt: "Porsche 911 Generation 996",
    description: "Der 996 leitete den größten technischen Umbruch der Baureihe ein. Wasserkühlung, eine neue Plattform und ein grundlegend überarbeitetes Design machten den 911 leistungsfähiger und zukunftsfähig."
  },
  {
    code: "997",
    model: "Porsche 911 997",
    period: "ca. 2004 bis 2012",
    image: "geschichte/assets/images/911-997.webp",
    alt: "Porsche 911 Generation 997",
    description: "Der 997 brachte die klassische runde Lichtsignatur zurück. Präzisere Fahrwerkstechnik, stärkere Motoren und eine breite Modellpalette verbanden Tradition mit moderner Performance."
  },
  {
    code: "991",
    model: "Porsche 911 991",
    period: "ca. 2011 bis 2019",
    image: "geschichte/assets/images/911-991.webp",
    alt: "Porsche 911 Generation 991",
    description: "Der 991 setzte auf einen längeren Radstand und eine leichtere Aluminium-Stahl-Karosserie. Dadurch gewann der 911 an Stabilität, Komfort und aerodynamischer Effizienz."
  },
  {
    code: "992",
    model: "Porsche 911 992",
    period: "seit ca. 2018",
    image: "geschichte/assets/images/911-992.webp",
    alt: "Porsche 911 Generation 992",
    description: "Der 992 führt die 911-Idee digital weiter. Breitere Proportionen, die durchgehende LED-Lichtleiste und ein modernes Cockpit verbinden hohe Alltagstauglichkeit mit typischer 911-Performance."
  }
];
...
/* ===== Gemeinsame Bild-Lightbox für die Geschichte-Unterseite ===== */
(function () {
  const zoomTargets = [
    ...document.querySelectorAll('#design-dna .card-media--design-dna'),
    ...document.querySelectorAll('#geschichte-wendepunkte .turning-card__image-wrapper'),
    ...document.querySelectorAll('#geschichte-systemblick .development-card__image-wrapper'),
    ...document.querySelectorAll('#geschichte-fazit .conclusion-card__image-wrapper')
  ];
  ...
  lightbox.innerHTML = `
    <div class="history-lightbox__dialog" role="dialog" aria-modal="true" aria-label="Vergrößerte Bildansicht">
      <button class="history-lightbox__close" type="button" aria-label="Vergrößerte Ansicht schließen">×</button>
      <figure class="history-lightbox__frame">
        <img class="history-lightbox__image" src="" alt="">
      </figure>
      <figcaption class="history-lightbox__caption"></figcaption>
    </div>
  `;

  document.body.appendChild(lightbox);

  const dialog = lightbox.querySelector('.history-lightbox__dialog');
  const image = lightbox.querySelector('.history-lightbox__image');
  const caption = lightbox.querySelector('.history-lightbox__caption');
  const closeButton = lightbox.querySelector('.history-lightbox__close');
  ...
  function openLightbox(trigger) {
    ...
    image.alt = sourceImage.alt || 'Vergrößerte Bildansicht';
    caption.textContent = sourceImage.alt || 'Vergrößerte Bildansicht';
  ...
  zoomTargets.forEach((trigger) => {
    const sourceImage = trigger.querySelector('img');
    const label = sourceImage?.alt ? `Bild groß ansehen: ${sourceImage.alt}` : 'Bild groß ansehen';
